...
def check_file(address_file):  #echo Checking module readability...
    ...
    try:
        ...
        try:
            ...
            # я считаю сюда попасть - еденичный случай. И если попасть в это
            # место, то (читая): файл нельзя закрыть или файл просто
            # изчез. Возможно этот просто сбой - еденичный случай.
